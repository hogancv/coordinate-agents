...
const VALUE_OPTIONS = new Set([
  ...
  '--reason', '--error-code', '--timeout', '--timeout-ms', '--session-wait-ms', '--max-waves', '--lang',
...
function defaultOptions() {
  return {
    ...
    timeoutMs: null, sessionWaitMs: null, maxWaves: null, port: 3000,
...
function assignValue(result, option, value) {
  ...
  if (option === '--max-waves') result.maxWaves = Number(value);
  if (option === '--port') {
