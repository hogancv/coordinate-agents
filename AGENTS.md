...
- `bin/coordinate-cli-agents.mjs`: installer, updater, doctor, quickstart, launch, and uninstall CLI.
- `scripts/agent-bus.mjs`: durable project-local message bus.
...
6. Keep English and Simplified Chinese user flows semantically synchronized. If commands,
   ...
   `README.md`, `README.zh-CN.md`, `AI_INSTALL.md`, `SKILL.md`, `SECURITY.md`, and `llms.txt`.
