...
- Additive Task Graph v1 validation plus durable graph create/status/inspect views, deterministic read-only scheduling plans, and one-subtask isolated worktree dispatch.
